...
private:
    ...
    void initScene() {
        computeModel.init(path_prefix + "/shaders/generated/mandelbrot.spv",
                          swapchainContext);
    ...
    void createComputeCommandBuffers() {
        ...
        for(size_t i = 0; i<computeCommandBuffers.size(); i++) {
            ...
            vkCmdDispatch(computeCommandBuffers[i], computeModel.targetTexture.width / 32, computeModel.targetTexture.height / 32, 1);
